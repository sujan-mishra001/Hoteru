...
import 'package:dautari_adda/features/pos/presentation/screens/takeaway_bill_screen.dart';
...
class _TakeawayOrderScreenState extends State<TakeawayOrderScreen> {
  ...
  Future<void> _loadActiveOrder() async {
    ...
    try {
      // Fetch order by ID for takeaway orders
      ...
      builder: (context, child) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text("Takeaway Order", style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 18)),
                            ...
                            if (_orderedItems.isEmpty)
                              Center(
                                child: Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      Icon(Icons.shopping_bag_rounded, size: 64, color: Colors.grey[300]),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    isOccupied ? "Order #${_activeOrder?['order_number'] ?? widget.orderId}" : "Loading...",
