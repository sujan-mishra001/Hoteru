            ...
            builder: (context, _) {
              ...
              return Column(
                children: [
                  ...
                  // Filter Segment integrated into Header
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          Expanded(child: _buildSaaSTab("All Orders", OrderStatus.all, isSelected: _selectedStatus == OrderStatus.all)),
                          Expanded(child: _buildSaaSTab("Drafts", OrderStatus.pending, isSelected: _selectedStatus == OrderStatus.pending)),
                          Expanded(child: _buildSaaSTab("Booked", OrderStatus.booked, isSelected: _selectedStatus == OrderStatus.booked)),
                        ],
                      ),
                    ),
                  ),
        ...
        builder: (context, _) {
          ...
          return Column(
            ...
            children: [
              ...
              // Filter Segment removed from here, moved to AppBar
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(tableName, style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 16)),
